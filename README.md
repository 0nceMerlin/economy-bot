...
# Setup
Install Node.js & npm.
Download files and run npm init in the folder. Press enter until it completes.
Install the following npm packages: npm i discord.js dotenv eslint mongoose parse-ms-2
Setup your MongoDB database and put the link in the .env file.
